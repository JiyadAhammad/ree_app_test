...
final Map<String, String> ruRU = {
  ...
  EnumLocal.txtOnBoardingSubTitle_1.name:
      "Откройте для себя будущее социальных сетей благодаря нашим передовым функциям и интуитивно понятному дизайну. Будьте готовы общаться, делиться и делать открытия, как никогда раньше!",
  EnumLocal.txtOnBoardingSubTitle_2.name:
      "Присоединяйтесь к глобальному сообществу, которое является страстным, разнообразным и ярким. Общайтесь с другими, делитесь своей историей и делайте мир меньше и прекраснее!",
  EnumLocal.txtOnBoardingSubTitle_3.name:
      "Наше приложение поможет вам: от обмена жизненными моментами до открытия новых интересов. Исследуйте, создавайте и процветайте в мире безграничных возможностей!",
  EnumLocal.txtLoginTitle.name: "Давайте познакомимся с новыми людьми вокруг вас",
  EnumLocal.txtLoginSubTitle.name:
      "Добро пожаловать! Быстро войдите в систему или используйте свою учетную запись Google, чтобы начать знакомиться с новыми людьми вокруг вас. Давайте начнем ваше путешествие к новым знакомствам!",
  ...
  EnumLocal.txtDeleteAccountText.name:
      "Вы уверены, что хотите навсегда удалить свою учетную запись? Это действие невозможно отменить, оно приведет к потере всех ваших данных и доступа к связанным службам.",
