...
final Map<String, String> esES = {
  ...
  EnumLocal.txtOnBoardingSubTitle_1.name:
      "Experimente el futuro de las redes sociales con nuestras funciones de vanguardia y diseño intuitivo. ¡Prepárate para conectarte, compartir y descubrir como nunca antes!",
  ...
  EnumLocal.txtOnBoardingSubTitle_3.name:
      "Desde compartir momentos de la vida hasta descubrir nuevos intereses, nuestra aplicación lo tiene cubierto. ¡Explora, crea y prospera en un mundo de infinitas posibilidades!",
  ...
  EnumLocal.txtStopLiveDialogText.name:
      "¿Detener la transmisión en vivo? Esta acción no se puede deshacer y finalizará la transmisión inmediatamente. Haga clic en Detener transmisión para confirmar.",
  ...
  EnumLocal.txtDeleteAccountText.name:
      "¿Estás seguro de que deseas eliminar permanentemente tu cuenta? Esta acción no se puede deshacer y resultará en la pérdida de todos sus datos y del acceso a los servicios asociados.",
