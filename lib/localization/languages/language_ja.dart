...
final Map<String, String> jaJP = {
  ...
  EnumLocal.txtMyQRCodeText.name:
      "私のQRコードページへようこそ！上の QR コードをスキャンすると、すぐに私のプロフィール データにアクセスできます。これには、私の連絡先情報、ソーシャル メディア プロフィール、および私と簡単につながるのに役立つその他の重要な詳細が含まれます。スマートフォンのカメラを QR コードにかざすだけで、私の個人的なプロフィール ページに移動します。接続を維持し、簡単にスキャンするだけで私についてもっと知ることができます。",
