...
final Map<String, String> koKR = {
  ...
  EnumLocal.txtMyQRCodeText.name:
      "내 QR 코드 페이지에 오신 것을 환영합니다! 위의 QR 코드를 스캔하면 내 프로필 데이터에 즉시 액세스할 수 있습니다. 여기에는 귀하가 저에게 쉽게 연락하는 데 도움이 되는 내 연락처 정보, 소셜 미디어 프로필 및 기타 필수 세부 정보가 포함됩니다. 스마트폰 카메라로 QR 코드를 가리키기만 하면 내 개인 프로필 페이지로 이동됩니다. 빠른 스캔만으로 연결을 유지하고 나에 대해 더 자세히 알아보세요!",
