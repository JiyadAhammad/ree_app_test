                      ...
                      : SingleChildScrollView(
                          ...
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, index) => UserListTile(
                              ...
                              callback: () => PreviewProfileBottomSheetUi.show(
                                  context: context, userId: controller.searchUsers[index].id ?? ""),
                            ),
                          ),
                        ),
            )
                      ...
                      : SingleChildScrollView(
                          ...
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, index) => UserListTile(
                              ...
                              callback: () => PreviewProfileBottomSheetUi.show(
                                  context: context, userId: controller.userCollection[index].id ?? ""),
                            ),
                          ),
                        ),
            ),
                            ...
                            itemBuilder: (context, index) => HashTagItemUi(
                              ...
                              onTap: () {
                                Get.toNamed(
                                  ...
                                  arguments: {
                                    "id": controller.searchHashTags[index].id,
                                    "name": controller.searchHashTags[index].hashTag
                                  },
                                );
                              },
                            ),
                            ...
                            itemBuilder: (context, index) => HashTagItemUi(
                              ...
                              onTap: () {
                                Get.toNamed(
                                  AppRoutes.previewHashTagPage,
                                  arguments: {
                                    "id": controller.hashTagCollection[index].id,
                                    "name": controller.hashTagCollection[index].hashTag
                                  },
                                );
                              },
                            ),
