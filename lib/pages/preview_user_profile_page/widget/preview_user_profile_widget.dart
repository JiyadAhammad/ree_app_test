...
class PreviewUserProfileAppBar extends StatelessWidget
              ...
              children: [
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    child:
                        Center(child: Image.asset(AppAsset.icBack, width: 25)),
                  ),
                ),
                5.width,
                Expanded(
                  ...
                  builder: (controller) => GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        shape: BoxShape.circle,
                        border: Border.all(
                            color: AppColor.colorTextGrey.withOpacity(0.8)),
                      ),
                      child: Center(
                          child: Image.asset(AppAsset.icMore,
                              color: AppColor.colorTextGrey.withOpacity(0.8),
                              width: 22)),
                    ),
                  ),
                      ...
                      return Stack(
                        ...
                        children: [
                          GestureDetector(
                            onTap: () {
                              if (!(controller
                                      .videoCollection[index].isBanned ??
                                  false)) {
                          ...
                          Visibility(
                            visible:
                                (controller.videoCollection[index].isBanned ??
                                    false),
                            child: Container(
                              height: Get.height,
                              ...
                              child: Padding(
                                ...
                                child: Image.asset(AppAsset.icNone,
                              ...
                              child: Row(
                                ...
                                children: [
                                  Image.asset(
                                    AppAsset.icLike,
                                    width: 18,
                                    color: (controller.videoCollection[index]
                                                .isLike ??
                                            false)
                  ...
                  itemBuilder: (context, index) {
                    return AspectRatio(
                      ...
                      child: GestureDetector(
                        onTap: () => Get.to(
                          PreviewImageUi(
                            name: controller.fetchProfileModel?.userProfileData
                                    ?.user?.name ??
                                "",
                            userName: controller.fetchProfileModel
                                    ?.userProfileData?.user?.userName ??
                                "",
                            userImage: controller.fetchProfileModel
                                    ?.userProfileData?.user?.image ??
                                "",
                            images:
                                controller.postCollection[index].postImage ??
                                    [],
                          ),
                        ),
                        child: Container(
                            ...
                            child: Stack(
                              ...
                              children: [
                                ...
                                AspectRatio(
                                  ...
                                  child: PreviewNetworkImageUi(
                                      image: controller
                                          .postCollection[index].mainPostImage),
                                ),
                                Align(
                                ...
                                Visibility(
                                  visible: !(controller.postCollection[index]
                                          .postImage?.length ==
                                      1),
                                  child: Positioned(
                                    top: 8,
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          controller.giftCollection[index].giftType == 1 ||
                              ...
                              ? Expanded(
                                  child: PreviewNetworkImageUi(
                                      image: controller.giftCollection[index]
                                              .giftImage ??
                                          ""),
                                )
                          ...
                          Container(
                            ...
                            child: Text(
                              ...
                              style:
                                  AppFontStyle.styleW700(AppColor.primary, 12),
                            ),
                          ),
                          8.height,
                          Container(
