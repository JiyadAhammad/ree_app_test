...
import 'package:shortie/pages/preview_user_profile_page/widget/preview_user_profile_widget.dart';
import 'package:shortie/shimmer/preview_user_profile_shimmer_ui.dart';
                  ...
                  builder: (controller) => controller.isLoadingProfile
                      ...
                      : Column(
                          ...
                          children: [
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child: PreviewNetworkImageUi(
                                          image: controller.fetchProfileModel
                            ...
                            Text(
                              controller.fetchProfileModel?.userProfileData
                                      ?.user?.userName ??
                                  "",
                              style: AppFontStyle.styleW400(
                                  AppColor.colorGreyHasTagText, 13),
                            ),
                            10.height,
                            Row(
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                                /// search this widget to get
                                      ...
                                      children: [
                                        Text(
                                          CustomFormatNumber.convert(controller
                                              ...
                                              0),
                                          style: AppFontStyle.styleW700(
                                              AppColor.colorDarkBlue, 18),
                                        ),
                                        2.height,
                                        Text(
                                          EnumLocal.txtLikes.name.tr,
                                          style: AppFontStyle.styleW400(
                                              AppColor.colorDarkBlue, 12),
                                        ),
                                      ],
                                    ),
                                  ),
              ...
              bottom: PreferredSize(
                ...
                child: Container(
                  ...
                  child: TabBar(
                    ...
                    labelStyle: AppFontStyle.styleW600(
                        AppColor.black.withOpacity(0.8), 13),
                    unselectedLabelColor: AppColor.colorUnselectedIcon,
                    indicatorSize: TabBarIndicatorSize.tab,
                    indicatorWeight: 2,
                    indicatorPadding:
                        const EdgeInsets.only(top: 72, right: 10, left: 10),
                    ...
                    tabs: <Tab>[
                      Tab(
                        icon: const ImageIcon(AssetImage(AppAsset.icReels),
                            size: 30),
                        text: EnumLocal.txtReels.name.tr,
                      ),
                      Tab(
                        icon: const ImageIcon(AssetImage(AppAsset.icFeeds),
                            size: 30),
                        text: EnumLocal.txtFeeds.name.tr,
                      ),
                      Tab(
                        icon: const ImageIcon(
                            AssetImage(AppAsset.icCollections),
                            size: 30),
