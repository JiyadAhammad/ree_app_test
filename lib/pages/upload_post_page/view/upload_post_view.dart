              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    //         keyboardType: TextInputType.name,
                    //         isOptional: true,
                    //         onTap: () => controller.onToggleHashTag(true),
                    //         onFieldSubmitted: () => controller.onToggleHashTag(false),
                    //         onChanged: () async {
                    //           await controller.onGetHashTag();
                    //
                    //           if (controller.hashTagController.text.trim().isNotEmpty) {
                    //             if (controller.hashTagController.text.endsWith(" ")) {
                    //               if (controller.hastTagCollection.isNotEmpty) {
                    //                 final userHashTag = controller.hashTagController.text.trim().toLowerCase();
                    //                 final apiHashTag = controller.hastTagCollection[0].hashTag?.toLowerCase();
                    //                 Utils.showLog("********* ${userHashTag} ****** ${apiHashTag} ");
                    //                 if (userHashTag == apiHashTag) {
                    //                   controller.onSelectHastTag(0);
                    //                 } else {
                    //                   controller.onCreateHashTag();
                    //                   Utils.showLog("********* Create New HashTag ");
                    //                 }
                    //               } else {
                    //                 controller.onCreateHashTag();
                    //                 Utils.showLog("********* Create New HashTag ");
                    ...
                    //                                       controller.hastTagCollection[index].totalHashTagUsedCount ??
                    //                                           0),
...
class UploadTextFiledUi extends StatelessWidget {
  const UploadTextFiledUi({
    super.key,
    required this.title,
