    ...
    return PopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          flexibleSpace:
              FillProfileAppBarUi(title: EnumLocal.txtFillProfile.name.tr),
        ),
              ...
              children: [
                            ...
                            GetBuilder<FillProfileController>(
                              ...
                              builder: (controller) => Container(
                                ...
                                child: controller.pickImage == null
                                    ...
                                    : Image.file(File(controller.pickImage!),
                                        fit: BoxFit.cover),
                              ),
                            ),
                            Align(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  shape: BoxShape.circle,
                                  border: Border.all(
                                      color: AppColor.colorBorder, width: 1.5),
                                ),
                ...
                FillProfileFieldUi(
                  ...
                  suffixIcon: SizedBox(
                    ...
                    width: 20,
                    child: Center(
                      child: Image.asset(AppAsset.icEditPen,
                          height: 20, width: 20),
                    ),
                  ),
                ),
