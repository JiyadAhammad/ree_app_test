...
class SettingController extends GetxController {
  ...
  Future<void> onDeleteAccount() async {
    ...
    deleteUserModel =
        await DeleteUserApi.callApi(loginUserId: Database.loginUserId);
        ...
        child: Column(
          children: [
            ...
            QrImageView(
              ...
              size: 140.0,
              eyeStyle: QrEyeStyle(
                  color: AppColor.white, eyeShape: QrEyeShape.square),
            ...
            Row(
              ...
              children: [
                ...
                Visibility(
                  visible:
                      Database.fetchLoginUserProfileModel?.user?.isVerified ??
                          false,
                  child: Padding(
