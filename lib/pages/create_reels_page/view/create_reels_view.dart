                    ...
                    builder: (controller) => Container(
                      ...
                      child: Align(
                        ...
                        child: AnimatedContainer(
                          ...
                          height: 6,
                          width: controller.countTime *
                              ((Get.width - 30) / controller.selectedDuration),
                          child: Container(
                            decoration: BoxDecoration(
                              borderRadius: BorderRadius.circular(10),
                          ...
                          children: [
                            ...
                            AspectRatio(
                              ...
                              child: PreviewNetworkImageUi(
                                  image: controller.selectedSound?["image"]),
                            ),
                          ],
                        ),
                      ),
                          ...
                          itemBuilder: (context, index) => Padding(
                            ...
                            child: GetBuilder<CreateReelsController>(
                              ...
                              builder: (controller) => index == 0
                                  ? GestureDetector(
                                      onTap: () =>
                                          controller.onClearEffect(index),
                                      child: SizedBox(
                                        width: 90,
                                        child: Column(
                                          mainAxisAlignment:
                                            ...
                                            SizedBox(
                                              ...
                                              child: Text(
                                                ...
                                                style: AppFontStyle.styleW400(
                                                    controller.selectedEffectIndex ==
                                                            index
                                                        ? AppColor.primary
                                                        : AppColor.white,
                                                    14.5),
                                  ...
                                  : GestureDetector(
                                      onTap: () =>
                                          controller.onChangeEffect(index),
                                      child: SizedBox(
                                        width: 90,
                                        child: Column(
                                          mainAxisAlignment:
                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (context, index) => Padding(
                              ...
                              child: GestureDetector(
                                onTap: () =>
                                    logic.onChangeRecordingDuration(index),
                                child: Container(
                                  height: 20,
                                  width: 65,
                                  decoration: BoxDecoration(
                                    color: logic.selectedDuration ==
                                            logic.recordingDurations[index]
                                        ? null
                                        : AppColor.white.withOpacity(0.1),
                                    gradient: logic.selectedDuration ==
                                            logic.recordingDurations[index]
                              ...
                              children: [
                                SizedBox(
                                  ...
                                  child: CircularProgressIndicator(
                                    value: controller.isRecording == "stop"
                                        ? 1
                                        : controller.countTime *
                                            (1 / controller.selectedDuration),
                                    backgroundColor:
                                        AppColor.white.withOpacity(0.2),
                                    color: controller.isRecording == "stop"
                                        ? AppColor.white
                                        : AppColor.colorTabBar,
                                    strokeWidth: 8,
                                ...
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    shape: BoxShape.circle,
                                    color: AppColor.white,
                                    gradient: controller.isRecording == "stop"
                                        ? AppColor.primaryLinearGradient
                                        : null,
                                  ),
                                  child: Center(
      ...
      child: Stack(
        ...
        children: [
          GetBuilder<CreateReelsController>(
            ...
            builder: (controller) => Visibility(
              visible: controller.isShowEffects == false,
                            ...
                            children: [
                              ...
                              controller.isRecording == "start"
                                  ? CircleIconButtonUi(
                                      ...
                                      color: AppColor.white,
                                      callback: () =>
                                          controller.onClickRecordingButton(),
                                    )
