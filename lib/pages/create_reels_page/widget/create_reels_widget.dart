              ...
              child: GetBuilder<CreateReelsController>(
                ...
                builder: (logic) => PageView.builder(
                  ...
                  itemBuilder: (context, index) =>
                      logic.soundTabPages[logic.selectedTabIndex],
                ),
              ),
            ),
          ],
  ...
  Widget build(BuildContext context) {
    return Container(
      decoration: BoxDecoration(
        color: AppColor.transparent,
        border: Border(
            bottom: BorderSide(color: AppColor.colorBorder.withOpacity(0.3))),
      ),
      child: GetBuilder<CreateReelsController>(
        id: "onChangeTabBar",
        builder: (logic) => Row(
          ...
          child: Center(
            child: Text(
              ...
              style: AppFontStyle.styleW500(
                  isSelected ? AppColor.primary : AppColor.coloGreyText, 17),
            ),
          ),
        ),
      ),
                          ...
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, index) =>
                              ...
                              builder: (controller) => SoundItemUi(
                                ...
                                songTitle:
                                    controller.searchSounds[index].songTitle ??
                                        "",
                                songImage:
                                    controller.searchSounds[index].songImage ??
                                        "",
                                songCategoryName: controller
                                        .searchSounds[index].songCategoryName ??
                                    "",
                                singerName:
                                    controller.searchSounds[index].singerName ??
                                        "",
                                songTime: CustomFormatTime.convert(
                                    controller.searchSounds[index].songTime ??
                                        0),
                                isFavorite:
                                    controller.searchSounds[index].isFavorite ??
                                        false,
                                isSelected: controller.selectedSound?["id"] ==
                                    (controller.searchSounds[index].id ?? ""),
                                callback: () => controller.onChangeSound(
                                  {
                                    "id":
                                        controller.searchSounds[index].id ?? "",
                                    "name": controller
                                            .searchSounds[index].songTitle ??
                                        "",
                                    "image": controller
                                            .searchSounds[index].songImage ??
                                        "",
                                    "link": (Api.baseUrl +
                                        (controller
                                                .searchSounds[index].songLink ??
                                            "")),
                                  },
                                ),
                              ),
                            ...
                            itemBuilder: (context, index) =>
                              ...
                              builder: (controller) => SoundItemUi(
                                ...
                                songTitle: controller
                                        .mainSoundCollection[index].songTitle ??
                                    "",
                                songImage: controller
                                        .mainSoundCollection[index].songImage ??
                                    "",
                                songCategoryName: controller
                                        .mainSoundCollection[index]
                                        .songCategoryName ??
                                    "",
                                singerName: controller
                                        .mainSoundCollection[index]
                                        .singerName ??
                                    "",
                                songTime: CustomFormatTime.convert(controller
                                        .mainSoundCollection[index].songTime ??
                                    0),
                                isFavorite: controller
                                    ...
                                    false,
                                isSelected: controller.selectedSound?["id"] ==
                                    (controller.mainSoundCollection[index].id ??
                                        ""),
                                callback: () => controller.onChangeSound({
                                  "id": controller
                                          .mainSoundCollection[index].id ??
                                      "",
                                  "name": controller.mainSoundCollection[index]
                                          .songTitle ??
                                      "",
                                  "image": controller.mainSoundCollection[index]
                                          .songImage ??
                                      "",
                                  "link": Api.baseUrl +
                                      (controller.mainSoundCollection[index]
                                              .songLink ??
                                          ""),
                                }),
                              ),
              ...
              builder: (controller) => controller.isLoadingFavoriteSound
                  ...
                  : controller.favoriteSoundCollection.isEmpty
                      ...
                      : SingleChildScrollView(
                          ...
                          child: ListView.builder(
                            itemCount:
                                controller.favoriteSoundCollection.length,
                            shrinkWrap: true,
                            physics: const NeverScrollableScrollPhysics(),
                            itemBuilder: (context, index) =>
                                GetBuilder<CreateReelsController>(
                              id: "onChangeSound",
                              builder: (controller) => SoundItemUi(
                                id: controller.favoriteSoundCollection[index]
                                        .songId?.id ??
                                    "",
                                songTitle: controller
                                        .favoriteSoundCollection[index]
                                        .songId
                                        ?.songTitle ??
                                    "",
                                songImage: controller
                                ...
                                isFavorite: true,
                                isSelected: controller.selectedSound?["id"] ==
                                    (controller.favoriteSoundCollection[index]
                                            .songId?.id ??
                                        ""),
                                callback: () => controller.onChangeSound({
                                  "id": controller
...
class _SoundItemUiState extends State<SoundItemUi> {
  ...
  Future<void> onChangeFavorite() async {
    ...
    await FavoriteUnFavoriteApi.callApi(
        loginUserId: Database.loginUserId, soundId: widget.id);
  }
            ...
            Container(
              ...
              child: Stack(
                ...
                children: [
                  ...
                  AspectRatio(
                      aspectRatio: 1,
                      child: PreviewNetworkImageUi(image: widget.songImage)),
                ],
              ),
            ),
            15.width,
    ...
    return GestureDetector(
      child: isSelected
          ? Container(
              ...
              child: Center(
                child:
                    Icon(Icons.done_rounded, color: AppColor.white, size: 15),
              ),
            )
          : Offstage(),
    );
