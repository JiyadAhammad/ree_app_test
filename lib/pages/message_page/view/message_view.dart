        ...
        child: SingleChildScrollView(
          child: SizedBox(
            height: Get.height +
                1 -
                AppConstant
                    .bottomBarSize, // This Is Use To Active Refresh Indicator
            child: Column(
              children: [
                  ...
                  builder: (controller) => SafeArea(
                    ...
                    child: Center(
                      child: AnimatedContainer(
                        ...
                        height: controller.isShowSearchMessageUserHistory
                            ? 215
                            : 52,
                        decoration: BoxDecoration(
                          color: controller.isShowSearchMessageUserHistory
                              ? AppColor.colorUnselectedIcon.withOpacity(0.05)
                              : AppColor.transparent,
                          borderRadius: BorderRadius.circular(26),
                          border: Border.all(
                            color: controller.isShowSearchMessageUserHistory
                                ? AppColor.colorBorder.withOpacity(0.5)
                                : AppColor.transparent,
                          ),
                        ),
                        margin:
                          ...
                          children: [
                            GetBuilder<MessageController>(
                              ...
                              builder: (controller) => SearchMessageUserUi(
                                ...
                                callback: () =>
                                    controller.onChangeSearchHistory(true),
                                    ...
                                    : SingleChildScrollView(
                                        ...
                                        child: ListView.builder(
                                          itemCount: controller
                                              .searchMessageUsers.length,
                                          shrinkWrap: true,
                                          physics:
                                              const NeverScrollableScrollPhysics(),
                                          padding: EdgeInsets.zero,
                                          itemBuilder: (context, index) {
                                            final searchUser = controller
                                                .searchMessageUsers[index];
                            ...
                            builder: (controller) => controller.isLoading
                                ...
                                : controller.messageUsers.isEmpty
                                    ...
                                    : SingleChildScrollView(
                                        ...
                                        child: ListView.builder(
                                          itemCount:
                                              controller.messageUsers.length,
                                          shrinkWrap: true,
                                          physics:
                                              const NeverScrollableScrollPhysics(),
                                          padding: EdgeInsets.zero,
                                          itemBuilder: (context, index) {
                                            final messageUser =
                                                controller.messageUsers[index];
                                            return MessageUserUi(
                                              title: messageUser.name ?? "",
                                              subTitle: messageUser.message ==
                                                          null ||
                                                      messageUser.message == ""
