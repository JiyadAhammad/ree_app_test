                ...
                children: [
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Center(
                          child: Image.asset(AppAsset.icSearch, width: 18)),
                    ),
                  ),
                  8.width,
                  GestureDetector(
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: const BoxDecoration(
                          ...
                          shape: BoxShape.circle),
                      child: Center(
                          child: Image.asset(AppAsset.icQr,
                              color: AppColor.white, width: 18)),
                    ),
                  ),
                ],
              ),
                    ...
                    child: Container(
                      ...
                      child: Stack(
                        ...
                        children: [
                          Positioned(
                            left: -5,
                            child: Lottie.asset(AppAsset.lottieWaveAnimation,
                                fit: BoxFit.cover, height: 20, width: 15),
                          ),
                          Positioned(
                            right: 5,
                            child: Text(
