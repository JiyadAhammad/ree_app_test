              ...
              children: [
                ...
                Expanded(
                  child: SizedBox(
                    ...
                    child: Stack(
                      children: [
                        Image.asset(AppAsset.icChatBackGround,
                                ...
                                : Obx(
                                    () {
                                      ...
                                      return SocketServices.userChats.isEmpty
                                          ? NoDataFoundUi(
                                              iconSize: 160, fontSize: 19)
                                          : SingleChildScrollView(
                                              controller: SocketServices
                                                  .scrollController,
                                              padding: EdgeInsets.only(
                                                  left: 15, right: 15, top: 15),
                                              child: ListView.builder(
                                                itemCount: SocketServices
                                                    .userChats.length,
                                                shrinkWrap: true,
                                                physics:
                                                    NeverScrollableScrollPhysics(),
                                                itemBuilder: (context, index) {
                                                  final chat = SocketServices
                                                      .userChats[index];
