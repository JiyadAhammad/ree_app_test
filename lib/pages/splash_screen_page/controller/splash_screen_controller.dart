  ...
  Future<void> init() async {
    ...
    if (InternetConnection.isConnect.value) {
      ...
      if (AdminSettingsApi.adminSettingModel?.data != null) {
        Utils.showLog("Admin Setting Api Calling sucess and adata come !!");
        await splashScreen();
    ...
    Timer(
      ...
      () {
        ...
        if (Database.isNewUser == false &&
          ...
          // Check User Is Fill Profile Or Not...
          if (Database.fetchLoginUserProfileModel?.user?.country == "" ||
              Database.fetchLoginUserProfileModel?.user?.bio == "") {
