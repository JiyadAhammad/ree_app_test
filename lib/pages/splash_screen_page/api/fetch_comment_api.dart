...
class FetchCommentApi {
  static Future<CommentModel?> callApi(
      {required String loginUserId, required int commentType, required String commentTypeId}) async {
    Utils.showLog("Get Comment Api Calling...");

    final queryParameters = commentType == 1
        ? "?userId=$loginUserId&type=post&postId=$commentTypeId"
        : "?userId=$loginUserId&type=video&videoId=$commentTypeId";
