                            ...
                            Obx(
                              () => SizedBox(
                                ...
                                child: AnimatedContainer(
                                  ...
                                  height:
                                      isShowLikeIconAnimation.value ? 15 : 50,
                                  width:
                                      isShowLikeIconAnimation.value ? 15 : 50,
                                  alignment: Alignment.center,
                            ...
                            Obx(
                              () => Text(
                                CustomFormatNumber.convert(
                                    customChanges["like"]),
                                style:
                                    AppFontStyle.styleW700(AppColor.white, 14),
                              ),
                            ),
                            15.height,
                            CustomIconButton(
                              ...
                              child: Stack(
                                ...
                                children: [
                                  ...
                                  Positioned(
                                    right: 4,
                                    bottom: -4,
                                    child: Image.asset(AppAsset.icMusic,
                                        width: 20),
                                  ),
                                ],
                              ),
                    ...
                    Positioned(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          if (controller.mainReels[widget.index].hashTag
                                  ?.isNotEmpty ??
                              false)
                            Column(
                              children: [
                                ...
                                SizedBox(
                                  ...
                                  child: Text(
                                    maxLines: 2,
                                    controller.mainReels[widget.index].hashTag
                                            ?.map((e) => " #$e")
                                            .join('')
                                            .toString() ??
                                        "",
                          ...
                          if (controller.mainReels[widget.index].caption
                                  ?.isNotEmpty ??
                              false)
                            Column(
                              children: [
                                ...
                                SizedBox(
                                  ...
                                  child: Text(
                                    controller
                                            .mainReels[widget.index].caption ??
                                        "",
                                    maxLines: 3,
                                    style: AppFontStyle.styleW600(
                                        AppColor.white, 13),
