...
import 'package:shortie/pages/feed_page/api/post_share_api.dart';
...
import 'package:shortie/ui/preview_images_dialog_ui.dart';
...
import 'package:shortie/pages/feed_page/api/post_like_dislike_api.dart';
...
class _PostViewState extends State<PostView> {
  ...
  Future<void> onClickLike() async {
    ...
    await PostLikeDislikeApi.callApi(
        loginUserId: Database.loginUserId, postId: widget.id);
  }
  ...
  Future<void> onClickFollow() async {
    if (Database.loginUserId != widget.userId) {
      ...
      await FollowUnfollowApi.callApi(
          loginUserId: Database.loginUserId, userId: widget.userId);
    } else {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        border: Border.symmetric(
          horizontal:
              BorderSide(color: AppColor.colorBorderGrey.withOpacity(0.4)),
        ),
        ...
        children: [
          GestureDetector(
            ...
            child: Container(
              ...
              color: AppColor.colorGreyBg.withOpacity(0.7),
              width: Get.width,
              child: Row(
                ...
                children: [
                  Container(
                    ...
                    decoration: const BoxDecoration(
                        shape: BoxShape.circle, color: AppColor.colorBorder),
                    child: Stack(
                      children: [
                        AspectRatio(
                          aspectRatio: 1,
                        ...
                        AspectRatio(
                          aspectRatio: 1,
                          child:
                              PreviewNetworkImageUi(image: widget.profileImage),
                        ),
                      ],
                    ),
                  ),
                            ...
                            children: [
                              ...
                              Visibility(
                                ...
                                child: Padding(
                                  ...
                                  child: Image.asset(AppAsset.icBlueTick,
                                      width: 20),
                                ),
                              ),
                            ],
                            ...
                            children: [
                              Image.asset(
                                  isFollow.value
                                      ...
                                      : AppAsset.icFollow,
                                  color: isFollow.value ? AppColor.white : null,
                                  width: 18),
                              5.width,
                              Text(
                                isFollow.value
            ...
            child: Column(
              ...
              children: [
                    ...
                    for (int index = 0; index < widget.hastTag.length; index++)
                      Container(
                        ...
                        decoration: BoxDecoration(
                          borderRadius: BorderRadius.circular(20),
                          border: Border.all(
                              color: AppColor.colorBorderGrey, width: 1),
                        ),
                        child: Text.rich(
                          TextSpan(
                            children: [
                              ...
                              TextSpan(
                                ...
                                style: AppFontStyle.styleW500(
                                    AppColor.colorGreyHasTagText, 12),
                              ),
                            ],
                          ),
                        ),
                ...
                Text(
                  widget.time,
                  style: AppFontStyle.styleW500(
                      AppColor.colorGreyHasTagText.withOpacity(0.8), 12),
                ),
                8.height,
                Row(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Text(
                                ...
                                style:
                                    AppFontStyle.styleW700(AppColor.black, 15),
                              ),
                              5.width
                            ],
                          ),
...
Widget iconView({
  ...
  return Row(
    children: [
      Image.asset(image,
          color: color ?? AppColor.colorUnselectedIcon, width: 24),
      5.width,
      countText != null
          ? Text(
              countText,
                ...
                children: [
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Center(
                          child: Image.asset(AppAsset.icSearch, width: 20)),
                    ),
                  ),
                  10.width,
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          Image.asset(AppAsset.icCreatePlus, width: 20),
                          5.width,
                          Text(
