...
class PreviewProfileBottomSheetUi {
  ...
  static Future<void> onGetProfile(String userId) async {
    ...
    if (fetchProfileModel?.userProfileData?.user?.name != null) {
      isFollow.value =
          fetchProfileModel?.userProfileData?.user?.isFollow ?? false;
                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Visibility(
                                    visible: fetchProfileModel?.userProfileData
                                            ?.user?.isVerified ??
                                        false,
                                    child: Padding(
                              ...
                              Row(
                                ...
                                children: [
                                  SizedBox(
                                    width: 22,
                                    child: Text(
                                      fetchProfileModel?.userProfileData?.user
                                              ?.countryFlagImage ??
                                          "🇮🇳",
                                      maxLines: 1,
                                      style: AppFontStyle.styleW700(
                                  ...
                                  Container(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Image.asset(
                                          fetchProfileModel?.userProfileData
                                                      ?.user?.gender
                                                      ?.toLowerCase()
                                                      .trim() ==
                                                  "male"
                                  ...
                                  GestureDetector(
                                    onTap: () {
                                      Get.toNamed(
                                        ...
                                        arguments: {
                                          "id": userId,
                                          "name": fetchProfileModel
                                                  ?.userProfileData
                                                  ?.user
                                                  ?.name ??
                                              "",
                                          "userName": fetchProfileModel
                                                  ?.userProfileData
                                                  ?.user
                                                  ?.userName ??
                                              "",
                                    ...
                                    child: Container(
                                      ...
                                      child: Image.asset(AppAsset.icSayHey,
                                          width: 28),
                                    ),
                                  ),
                                ],
